...
zenxd/zenx-qt (on Linux). If you upgrade after DIP0003 activation and you were
using version < 0.13 you will have to reindex (start with -reindex-chainstate
or -reindex) to make sure your wallet has all the new data synced. Upgrading from
version 0.13 should not require any additional actions.

When upgrading from a version prior to 0.14.0.3, the
first startup of Zentoshi Core will run a migration process which can take a few minutes
...
zenxd.exe -printcrashinfo=bvcgc43iinzgc43ijfxgm3yba....
```
...
- individual ZenX-specific fields which were used to display soft-fork progress in `getblockchaininfo` are replaced
...
Most of the changes between Bitcoin Core 0.14 and Bitcoin Core 0.15 have been backported into Zentoshi Core 0.15.
We only excluded backports which do not align with ZenX, like SegWit or RBF related changes.
...
Miscellaneous
-------------
A lot of refactoring, backports, code cleanups and other small fixes were done in this release. ZenX-specific
...
- [`05ac4dbb4`](https://github.com/dashpay/dash/commit/05ac4dbb4) ZenXify few strings (#3214)
...
- [`d49ee618f`](https://github.com/dashpay/dash/commit/d49ee618f) Add more logging to ZenXTestFramework (#3130)
...
- [`737ac967f`](https://github.com/dashpay/dash/commit/737ac967f) Refactor some ZenX-specific `wait_for*` functions in tests (#3122)
...
- [`acab8c552`](https://github.com/dashpay/dash/commit/acab8c552) Add Zentoshi Core Group codesign certificate (#3027)
...
- [`32aa229c7`](https://github.com/dashpay/dash/commit/32aa229c7) Reorganize ZenX Specific code into folders (#2753)

Zentoshi Core version 0.13.0.0
==========================
...
zenxd/zenx-qt (on Linux). If you upgrade after DIP0003 activation you will
...
and outputs, they are most useful for financial transactions (i.e. transfers of quantities of ZenX
...
The introduction of special transactions will require the whole ZenX ecosystem to perform a one-time
...
entry to that masternode list after the owner created a 1000 ZenX UTXO and the masternode broadcast
...
transaction which includes either a 1000-ZenX collateral payment or a reference to it, along with
...
Upgrade instructions: https://docs.zenx.org/DIP3-masternode-upgrade

DIP0004 - Simplified Verification of Deterministic Masternode Lists
-------------------------------------------------------------------
A verifiable and correct masternode list is foundational to many ZenX features, including verification
...
`privatesendsessions` cmd-line option or zenx.conf. You can pick any number of sessions between 1 and 10,
default is 4 which should be good enough for most users. For this feature to work you should also make
sure that `privatesendmultisession` is set to `1` via cmd-line or `Enable PrivateSend multi-session` is
enabled in GUI.

Introducing parallel mixing sessions should speed mixing up which makes it reasonable to add a new
mixing denom (0.00100001 ZENX) now while keeping all the old ones too. It also makes sense to allow more
...
- [`0692de1c5`](https://github.com/dashpay/dash/commit/0692de1c5) Fix prepare_masternodes/create_masternodes in ZenXTestFramework (#2382)
...
- [`1681d6366`](https://github.com/dashpay/dash/commit/1681d6366) Replace ZenX-specific threads with ZenX-specific scheduled tasks (#2043)
...
- [`e23339d6f`](https://github.com/dashpay/dash/commit/e23339d6f) use nullptr in ZenX-specific code (#2166)
...
- [`8ee9333bc`](https://github.com/dashpay/dash/commit/8ee9333bc) remove boost dependency from ZenX-specific code (#2072)

Zentoshi Core version 0.16.1.0
==========================
...
first startup of Zentoshi Core will run a migration process which can take a few
...
- Starting Zentoshi Core compiled without wallet support or with `-disablewallet` command line

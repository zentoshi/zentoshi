...
* zenx.conf: contains configuration settings for zenxd or zenx-qt
* zenxd.pid: stores the process id of zenxd while running
...
* debug.log: contains debug information and general logging generated by zenxd or zenx-qt

...
This document provides guidelines for internationalization of the Zentoshi Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zenx_en.ts` remains unchanged.

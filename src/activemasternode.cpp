...
void CActiveLegacyMasternodeManager::ManageState(CConnman& connman)
{
    ...
    LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageState -- Start\n");
    if (!fMasternodeMode) {
        LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageState -- Not a masternode, returning\n");
        return;
    }
    ...
    LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageState -- status = %s, type = %s, pinger enabled = %d\n", GetStatus(), GetTypeString(), fPingerEnabled);
...
bool CActiveLegacyMasternodeManager::SendMasternodePing(CConnman& connman)
{
    ...
    if (!fPingerEnabled) {
        LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::SendMasternodePing -- %s: masternode ping service is disabled, skipping...\n", GetStateString());
        return false;
    }
...
void CActiveLegacyMasternodeManager::ManageStateInitial(CConnman& connman)
{
    ...
    LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageStateInitial -- status = %s, type = %s, pinger enabled = %d\n", GetStatus(), GetTypeString(), fPingerEnabled);
    ...
    LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageStateInitial -- End status = %s, type = %s, pinger enabled = %d\n", GetStatus(), GetTypeString(), fPingerEnabled);
}
...
void CActiveLegacyMasternodeManager::ManageStateRemote()
{
    ...
    LogPrint(BCLog::MASTERNODE, "CActiveLegacyMasternodeManager::ManageStateRemote -- Start status = %s, type = %s, pinger enabled = %d, keyIDOperator = %s\n",

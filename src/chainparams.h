 ...
 * ZenX system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<std::string> masterMiningKeys() const { return vMasterMiningKeys; }
...
protected:
    ...
    std::vector<std::string> vMasterMiningKeys;

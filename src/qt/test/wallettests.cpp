...
//
//     src/qt/test/test_zenx-qt -platform xcb      # Linux
//     src/qt/test/test_zenx-qt -platform windows  # Windows
//     src/qt/test/test_zenx-qt -platform cocoa    # macOS
void TestGUI()
{
    GUIUtil::loadFonts();
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: zenx:")) != -1);

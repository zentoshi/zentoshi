    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  zenx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ZenX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 ZENX, 0.01 ZENX, 0.1 ZENX, 1 ZENX and 10 ZENX -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.zenx.org/en/stable/wallets/zenxcore/privatesend-instantsend.html\">PrivateSend documentation</a>."

# Linearize
Construct a linear, no-fork, best version of the ZenX blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install zenx_hash
...
JSON-RPC server. Running `zenxd` or `zenx-qt -server` will be sufficient.
...
* `input`: zenxd blocks/ directory containing blkNNNNN.dat

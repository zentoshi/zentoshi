...
Arguments:
    <base_directory> - The base directory of a Zentoshi Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Zentoshi Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Zentoshi Core repository.
"""

...
from test_framework.test_framework import ZenXTestFramework
...
class LLMQCoinbaseCommitmentsTest(ZenXTestFramework):
    def set_test_params(self):
        self.set_zenx_test_params(4, 3, fast_dip3_enforcement=True)
        self.set_zenx_dip8_activation(200)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ZenXTestFramework doesn't support this atm)

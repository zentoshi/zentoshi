Contributing to Zentoshi Core
============================

The Zentoshi Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zentoshi Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ZenX
Network Protocol consensus changes.

Whether a pull request is merged into Zentoshi Core rests with the project merge
...
Patches that change ZenX consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZenX consensus, it must have been
...
The review process is normally fairly responsive on the Zentoshi Core repository, however
...
The project leader is the release manager for each Zentoshi Core release.
